...
function StaffCard(props: {person: StaffMember}) {
   return (
      <div className="text-center">
         <div className="image-container aspect-w-1 aspect-h-1 bg-gray-900 rounded-xl overflow-hidden">
            ...
            <div className="aspect-w-1 aspect-h-1 bg-gray-900 rounded-xl overflow-hidden"><img src={props.person.hover} alt="" className="object-cover image-hover"></img></div>
         </div>
