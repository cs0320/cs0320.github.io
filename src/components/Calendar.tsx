...
function Calendar() {
  ...
  <div className="grid grid-cols-2 gap-4">
    <a className="quick-link" href="https://docs.google.com/forms/d/e/1FAIpQLScVR_C6BOdOuu7k_sbSQsc07DumOGJHV8w5EYlCh9GMNdisiw/viewform?usp=dialog" target="_blank" rel="noreferrer">Collab Section Swap Form</a>
    ...
    <a className="quick-link" href="https://docs.google.com/forms/d/e/1FAIpQLSeI8FOS1ciXUiCAx3uXEKU5n5_CxQbMb7zlQ4qYDfWfDgaJeA/viewform?usp=dialog" target="_blank" rel="noreferrer">Collaboration Crest Form</a>
  </div>
</div>
