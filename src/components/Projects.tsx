                      ...
                      <tr>
                        <td className="py-3">
                          <a
                            ...
                            className={
                              assignment.link
                                ? "inline-flex items-center hyperlink"
                                : "inline-flex items-center inactive-link"
                            }
                          >
        ...
        <div className="max-w-5xl mx-auto px-6 pt-16">
          ...
          <div className="text-sm md:text-base">
            ...
            >
              ...
              days immediately after each project's release. Attendance is
              mandatory, and gear-up sections will be assigned after shopping
              period ends.
            </p>
            <table className="table">
              <thead>
