...
function Projects() {
  return (
    <div>
      <section id="assignments">
        <div className="max-w-5xl mx-auto px-6 pt-16">
          ...
          <div className="text-sm md:text-base">
            <p>Project handouts are released at <b>8:00 AM ET</b> on the specified release day. Code submissions are due in Gradescope by <b>3:00 PM ET</b> on the specified due date. Synchronous demos will take place sometime within the demo window, depending on your and your mentor's availabilities. 
              ...
              <tbody>
                {AssignmentData && AssignmentData.map(assignment => {
                  return (
                    <tr>
                      <td className="py-3">
                        <a href={assignment.link} target="_blank" rel="noreferrer" className={assignment.link ? "inline-flex items-center hyperlink" : "inline-flex items-center inactive-link"}>
      ...
      <section id="gearups">
        <div className="max-w-5xl mx-auto px-6 pt-16">
        <img className='pb-8' src='/bee-divider.png' alt=""></img>
