                        ...
                        <div className="border-b border-violet-500">
                            ...
                            <Disclosure.Panel>
                                ...
                                {props.title === 'How to: Collab Section' && 
                                    <div>
                                        <li className='mb-2'>
                                        Arrive at your assigned collab section at the proper time every other week — use the <a className='underline hover:text-violet-500' href='https://docs.google.com/forms/d/e/1FAIpQLSfr8ELAYusLPSPEJcIA7Qjvu2BtDilXffdDibSKnW6IP41jqA/viewform?usp=sharing'>swap form</a> if you can't make it.
                                        </li>
                                        <li className='mb-2'>
                                    ...
                                    <div>
                                        <li className='mb-2'>
                                        Conceptual Hours hours are for questions about getting started, design, or prototyping. We intend for these hours to be a more collaborative space between students and TAs, but not a place for debugging code.
                                    </li>
                                    <li className='mb-2'>
